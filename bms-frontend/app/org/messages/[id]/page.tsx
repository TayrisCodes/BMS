  ...
  return (
    <div className="container mx-auto px-4 py-6 max-w-6xl">
      <div className="flex items-center gap-4 mb-6">
        <Button variant="ghost" size="icon" onClick={() => router.push('/org/messages')}>
        ...
        <div className="flex-1">
          ...
          {conversation.tenant && (
            <p className="text-muted-foreground">
              with {conversation.tenant.firstName} {conversation.tenant.lastName}
            </p>
          )}
        </div>
