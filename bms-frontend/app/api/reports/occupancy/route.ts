 ...
 * Get occupancy reports including total units, occupied units, vacancy rate, and building breakdown.
...
export async function GET(request: Request) {
  try {
    ...
    return NextResponse.json(
      { error: 'Unexpected error while generating occupancy report' },
      { status: 500 },
    );
  }
}
