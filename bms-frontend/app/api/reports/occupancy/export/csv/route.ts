...
import { exportOccupancyReport } from '@/modules/reports/export/csv';
...
export async function GET(request: Request) {
  try {
    ...
    // Generate CSV
    const csvContent = await exportOccupancyReport({
      summary: {
        totalUnits,
        occupiedUnits,
        availableUnits,
    ...
    const filename = `occupancy-report-${dateStr}.csv`;
    ...
    console.error('Occupancy CSV export error', error);
