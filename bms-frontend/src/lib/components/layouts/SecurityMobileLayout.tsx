...
export function SecurityMobileLayout({ children }: SecurityMobileLayoutProps) {
        ...
        <div className="flex h-14 items-center gap-3 px-4">
          ...
          <div className="flex flex-1 items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="truncate text-sm font-medium">{user?.name || 'Security'}</div>
              <div className="truncate text-xs text-muted-foreground">Security Guard</div>
            </div>
          </div>
